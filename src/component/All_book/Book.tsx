...
import { useGetsinglebookQuery, useSetreviewMutation } from '../../redux/features/book/bookApi'
            ...
            <div className="card shadow-sm mx-auto my-10">
...

                {
                    ...
                    <label className="flex p-5">
                        ...
                        />
                        <button className="w-20 bg-pink-600 text-white font-bold py-2 px-5" onClick={handleReview}>Add</button>
                    </label>
                            ...
                            data.data.Reviews.map((item:any)=>(
                               <>
                                <div className="card shadow-sm bg-slate-200 px-5 py-2">
                                    <h2 className="card-title text-base font-bold">{item?.Reviewer?.Name}</h2>
                                    <p className="text-base mx-2 my-1">{item.Review_Text}</p>
                                </div>
                               </>
                            ))
